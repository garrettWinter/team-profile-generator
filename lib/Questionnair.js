...
//This variable is used to allow the inquirer prompts to loop to allow for more employees to be added.
...
// This is the decision tree for which type of user should be added next.
        ...
        .prompt([
            {
                ...
                choices: [
                    "Engineer",
                    "Intern",
                    "No additional people report to this manager."]
            }
        ])
        .then((response) => {
            ...
            if (addEmployeeResponse.addEmployee === "No additional people report to this manager.") {
